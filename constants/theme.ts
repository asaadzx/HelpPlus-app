...
export const DarkColors = {
  ...
  onSurface: '#c7dde5',
  onSurfaceVariant: '#7a9aaa',
  outline: '#1a2a2a',
  outlineVariant: '#1a2a2a',
  error: '#ef4444',
  onError: '#FFFFFF',
  errorContainer: '#1a0a0a',
  onErrorContainer: '#fca5a5',
  success: '#48efb7',
  successContainer: '#065f34',
  onSuccessContainer: '#d1fae5',
  warning: '#fab300',
  warningContainer: '#1a1a0a',
...
export const ICON_PRESETS = [
  ...
  { name: 'tshirt', provider: 'MaterialCommunityIcons' as const, label: 'هدوم' },
